public class Test {
	public static void main(String[] args) {
		try {
			...
			// Test layer 2 frame
			L2Frame dllFrame = new L2Frame(2, 1, 0, 3, "00111100");
			...
			assert dllFrame.getDestAddress() == 2 : "dest address failed!";
			assert dllFrame.getSrcAddress() == 1 : "src address failed!";
			assert dllFrame.getType() == 0 : "type failed failed!";
			...
			// Test L2Handler
			L2Handler dllHandler = new L2Handler("localhost", LightSystem.DEFAULT_PORT, 13);
			assert dllHandler.getMacAddr() == 13 : "getMacAddr 1 failed!";
			System.out.println("macAddr: " + dllHandler.toString());

			L2Handler dllHandler2 = new L2Handler("localhost", LightSystem.DEFAULT_PORT, 9);
			assert dllHandler2.getMacAddr() == 9 : "getMacAddr 2 failed!";
			...
			L2Handler dllHandler3 = new L2Handler("localhost", LightSystem.DEFAULT_PORT, 11);
